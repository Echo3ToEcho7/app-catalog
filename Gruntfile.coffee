module.exports = (grunt) ->
  ...
  grunt.registerTask 'ci', 'Does a full build, runs tests and deploys to nexus', ['build', 'test:conf', 'express:inline', 'webdriver_jasmine_runner:chrome', 'webdriver_jasmine_runner:firefox', 'test:firefox', 'nexus:__createartifact__']
