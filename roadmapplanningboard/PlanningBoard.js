    ...
    Ext.define('Rally.apps.roadmapplanningboard.PlanningBoard', {
        ...
        _retrieveModels: function () {
            ...
            return this.featureStore.load(function () {
                _this.models = [_this.appModelFactory.getFeatureModel()];
        ...
        _addColumnFromNewTimeframe: function (timeframeName) {
            var timeframe;

            timeframe = Ext.create(this.appModelFactory.getTimeframeModel(), {
                name: timeframeName,
                start: null,
                end: null
            });
            return this._addColumnFromTimeframeAndPlan(timeframe, null);
        },
