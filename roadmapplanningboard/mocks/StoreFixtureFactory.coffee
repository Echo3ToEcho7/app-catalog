...
Ext.define 'Rally.test.apps.roadmapplanningboard.mocks.StoreFixtureFactory',
    requires: ['Rally.apps.roadmapplanningboard.AppModelFactory']

    getFeatureStoreFixture: ->
        return @featureStoreFixture if @featureStoreFixture

        @featureStoreFixture = Ext.create 'Ext.data.Store',
            requires: [
                'Rally.apps.roadmapplanningboard.FeatureModel'
            ]
    ...
    getSecondFeatureStoreFixture: ->
        return @secondFeatureStoreFixture if @secondFeatureStoreFixture
    ...
    getTimeframeStoreFixture: ->
        return @timeframeStoreFixture if @timeframeStoreFixture
